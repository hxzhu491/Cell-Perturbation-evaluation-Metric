...
```{r}
paths <- c("result/pred_NK.csv","result/pred_Dendritic.csv","result/pred_CD4T.csv","result/pred_B.csv","result/pred_FCGR3A.csv","result/pred_CD14.csv","result/pred_CD8T.csv")
scgen_pred <- list()
for (i in 1: length(ctype)){
