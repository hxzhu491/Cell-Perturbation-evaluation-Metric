...
r2 <- plot_grid(vp_iv, vp_tf, p_pr, NULL, vp_scgen, NULL, labels = c("c","","d","","",""), ncol=3,nrow=2,align = "hv",label_size = 18)

pdf("CD4T.pdf",height=14,width = 16)
plot_grid(r1,r2,nrow=2, align = "hv",rel_heights = c(1,3))
dev.off()
